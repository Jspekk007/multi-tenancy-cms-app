...
export const Add = (props) => (<svg {...baseProps} {...props}>
    <path d="M12 5v14"/>
    <path d="M5 12h14"/>
  </svg>);
export const Alert = (props) => (<svg {...baseProps} {...props}>
    <path d="M12 8v4"/>
    <path d="M12 15h.01"/>
    <path d="M10.29 3.86 1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0Z"/>
  </svg>);
export const ArrowDown = (props) => (<svg {...baseProps} {...props}>
    <path d="M12 5v14"/>
    <path d="m19 12-7 7-7-7"/>
  </svg>);
export const ArrowLeft = (props) => (<svg {...baseProps} {...props}>
    <path d="M19 12H5"/>
    <path d="m12 19-7-7 7-7"/>
  </svg>);
export const ArrowRight = (props) => (<svg {...baseProps} {...props}>
    <path d="M5 12h14"/>
    <path d="m12 5 7 7-7 7"/>
  </svg>);
export const ArrowUp = (props) => (<svg {...baseProps} {...props}>
    <path d="M12 19V5"/>
    <path d="m5 12 7-7 7 7"/>
  </svg>);
export const Check = (props) => (<svg {...baseProps} {...props}>
    <path d="M20 6 9 17l-5-5"/>
  </svg>);
export const Close = (props) => (<svg {...baseProps} {...props}>
    <path d="M18 6 6 18"/>
    <path d="m6 6 12 12"/>
  </svg>);
export const Delete = (props) => (<svg {...baseProps} {...props}>
    <path d="M3 6h18"/>
    <path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6"/>
    <path d="M10 11v6"/>
    <path d="M14 11v6"/>
  </svg>);
export const Edit = (props) => (<svg {...baseProps} {...props}>
    <path d="M11 4H6a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-5"/>
    <path d="M18.5 2.5 15.5 5.5 12 9l3.5 3.5 3.5-3.5 1.5-1.5z"/>
  </svg>);
export const Search = (props) => (<svg {...baseProps} {...props}>
    <circle cx="11" cy="11" r="7"/>
    <path d="m20 20-4.5-4.5"/>
  </svg>);
export const Settings = (props) => (<svg {...baseProps} {...props}>
...
export const User = (props) => (<svg {...baseProps} {...props}>
    <circle cx="12" cy="7" r="4"/>
    <path d="M5.5 21a7.5 7.5 0 0 1 13 0"/>
  </svg>);
export const Eye = (props) => (<svg {...baseProps} {...props}>
    <path d="M1 12s4-7 11-7 11 7 11 7-4 7-11 7S1 12 1 12Z"/>
    <circle cx="12" cy="12" r="3"/>
  </svg>);
export const EyeOff = (props) => (<svg {...baseProps} {...props} fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24">
