...
export const Default = {
    render: () => (<form className="demo-form">
      {/* Username */}
      ...
      {/* Email */}
      <FormFieldWrapper label="Email" required helperText="We'll never share your email." errorText="Invalid email address">
      ...
      {/* Search with icons */}
      <FormFieldWrapper label="Search" helperText="Search for something" prefixIcon={<BaseIcon icon="search"/>} suffixIcon={<BaseIcon icon="close"/>}>
