...
export class AuthService {
    ...
    async register(input) {
        ...
        customLogger.info(`Attempting to sign up user with email: ${normalizedEmail} and domain: ${input.domain}`);
        ...
        const { tenant, user, tenantUser } = await this.prisma.$transaction(async (tx) => {
            ...
            customLogger.info(`User ${createdUser.email} signed up for tenant ${createdTenant.name} (${createdTenant.domain})`);
